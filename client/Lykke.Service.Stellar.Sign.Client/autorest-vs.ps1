...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.Stellar.Sign.Client/AutorestClient --namespace=Lykke.Service.Stellar.Sign.Client.AutorestClient